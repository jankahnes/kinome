...
export const positiveAmountDescriptors = {
  F: { description: 'Not a source of', ...NEUTRAL },
  E: { description: 'Very low in', ...NEUTRAL },
  D: { description: 'Low in', ...NEUTRAL },
...
export const negativeAmountDescriptors = {
  ...
  A: { description: 'Very low in', ...GOOD },
  S: { description: 'Minimal', ...GOOD },
};
...
export function getHighestThreshold(
  value: number,
  thresholds: Record<number, any>,
) {
