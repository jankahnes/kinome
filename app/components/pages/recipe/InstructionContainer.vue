<template>
  <div class="space-y-2">
    <h2 class="text-4xl font-bold tracking-tighter ml-2" v-if="!hideHeader">Method</h2>
    <div
    ...
    >
      <div class="flex-1" v-if="instructions && instructions.length > 0">
        <div class="space-y-10">
          ...
          >
            <div
              class="min-w-9 h-9 p-1 rounded-xl flex items-center text-xl font-bold justify-center bg-primary-500 text-white flex-shrink-0 mt-1 leading-none"
            >
              {{ index + 1 }}
            </div>
