<template>
  <div ref="slider" class="relative w-full h-4 rounded" @mousedown="startDrag" @touchstart.prevent="startDrag">
    <div class="absolute top-1/2 left-0 w-full border-t border-gray-300/50 -translate-y-1/2"></div>

    <div ref="leftHandle"
      class="transition-none! main-button animated-button absolute! top-1/2 -translate-y-1/2 cursor-grab flex items-center justify-center px-3 py-0.5"
