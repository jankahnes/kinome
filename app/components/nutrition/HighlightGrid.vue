<template>
  <div class="flex flex-wrap gap-4">
    ...
    <div
      ...
      class="main-card flex flex-col gap-1 p-2 md:p-4 rounded-4xl items-center justify-center flex-1 basis-auto sm:basis-1/4"
    >
      <div
    ...
    <div
      ...
      :key="highlight.title"
      class="main-card flex flex-col p-2 md:p-4 rounded-4xl items-center flex-1 basis-auto sm:basis-1/4 max-w-100"
    >
      <NuxtImg
