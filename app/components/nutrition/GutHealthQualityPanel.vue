  ...
  <BlocksResponsiveInfo v-model="open" sidePanelClass="w-100">
    <div class="p-5 flex flex-col gap-5">
      <div>
        ...
        <h2 class="text-3xl font-headers tracking-tight">Gut Health</h2>
      </div>
      <div v-if="gutHealth">
        ...
        <div class="h-2 rounded-full bg-primary/8 overflow-hidden mb-5">
          <div class="h-full rounded-full bg-emerald-400 transition-all duration-300"
            :style="{ width: Math.max(0, gutHealth.overallScore) + '%' }" />
        </div>

        <div class="text-xs text-gray-400 uppercase tracking-wide mb-2">Gut-friendly factors</div>
        <div class="flex flex-col gap-2 mb-5">
          <div class="flex justify-between items-center p-3 rounded-xl"
            :class="gutHealth.fiberSubScore > 50 ? 'bg-emerald-50' : gutHealth.fiberSubScore > 20 ? 'bg-primary/8' : 'bg-orange-50'">
            <div>
          ...
          <div class="flex justify-between items-center p-3 rounded-xl"
            :class="gutHealth.polyphenolSubScore > 50 ? 'bg-emerald-50' : gutHealth.polyphenolSubScore > 20 ? 'bg-primary/8' : 'bg-orange-50'">
            <div>
              <div class="font-semibold text-sm"
        ...
        <div class="text-xs text-gray-400 uppercase tracking-wide mb-2">Impact factors</div>
        <div class="flex flex-col gap-2 mb-5">
          <div class="flex justify-between items-center p-3 rounded-xl"
            :class="gutHealth.processingSubScore > 50 ? 'bg-primary/8' : gutHealth.processingSubScore > 15 ? 'bg-orange-50' : 'bg-red-50'">
            <div>
              <div class="font-semibold text-sm"
          ...
          <div class="flex justify-between items-center p-3 rounded-xl"
            :class="gutHealth.sugarSubScore > 40 ? 'bg-primary/8' : gutHealth.sugarSubScore > 15 ? 'bg-orange-50' : 'bg-red-50'">
            <div>
              <div class="font-semibold text-sm"
          ...
          <div class="flex justify-between items-center p-3 rounded-xl"
            :class="gutHealth.sfatSubScore > 30 ? 'bg-primary/8' : gutHealth.sfatSubScore > 0 ? 'bg-orange-50' : 'bg-red-50'">
            <div>
              <div class="font-semibold text-sm"
          ...
          <div class="flex justify-between items-center p-3 rounded-xl"
            :class="gutHealth.sodiumSubScore > 30 ? 'bg-primary/8' : gutHealth.sodiumSubScore > 0 ? 'bg-orange-50' : 'bg-red-50'">
            <div>
              <div class="font-semibold text-sm"
