    ...
    <div v-if="food" class="mx-auto max-w-6xl px-4 pb-20 pt-4 md:px-8 md:pb-4 lg:px-10 space-y-5">
        ...
        <div class="space-y-10 md:space-y-12">
            <section class="space-y-4">
                <div class="space-y-3">
                    <p class="text-[11px] font-mono uppercase tracking-[0.22em] text-[#9d8a78]">
                ...
                <div class="flex gap-5 justify-between items-end flex-wrap">
                    <div class="space-y-5">
                        <div class="flex flex-col gap-3 items-start">
                            ...
                            <p v-if="foodMetaLine" class="text-[10px] text-gray-400 font-mono uppercase tracking-wider">
                                {{ foodMetaLine }}
                            </p>
                        </div>
                    </div>

                    <div class="p-3 md:p-4 bg-white md:bg-primary-5 border border-faint rounded-2xl flex-1 md:flex-0 md:mb-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="space-y-0.5">
                                <p class="text-[13px] font-semibold text-dark text-nowrap">{{ healthGradeLabel }}</p>
            ...
            <section class="space-y-4">
                ...
                <NutritionQualityList :quality-cards="qualityCards"
                    :food-row="food" @open-full-analysis="openHealthReport" />
            </section>
            ...
            <section v-if="suggestedSwaps.length" class="space-y-4">
                ...
                <div class="overflow-hidden main-card-rounded border border-[#f1ede9] gap-px flex flex-col">
                    <NuxtLink v-for="(swap, index) in suggestedSwaps" :key="swap.id"
                        :to="getFoodUrl(swap.id, swap.name)" class="flex gap-4 bg-primary-5 py-4 px-6 items-center ">
