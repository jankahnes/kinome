    ...
    <div class="max-w-screen-xl" v-if="mounted">
      <form @submit.prevent="handleSubmit" class="flex flex-col gap-2 xl:px-4 relative mt-10">
        <div
          ...
          :class="{ 'bg-primary-10': form.currentStep.value > 1 }"
          @click="form.currentStep.value = 1"
        >
          ...
          <BlocksCollapsible class="flex flex-col gap-4" :modelValue="form.currentStep.value === 1">
            ...
            <button
              ...
              @click.stop.prevent="form.currentStep.value = 2"
              :disabled="!form.canContinueToStep2.value"
            >
        ...
        <div
          ...
          class="w-full xl:py-4 xl:px-8 py-2 px-4 rounded-4xl transition-colors duration-400"
          :class="{ 'bg-primary-10': form.currentStep.value > 2 }"
          @click="form.currentStep.value = 2"
        >
          <div class="flex items-center justify-between">
            <div class="flex flex-col">
          ...
          <BlocksCollapsible class="flex flex-col gap-4" :modelValue="form.currentStep.value === 2">
            ...
            <button
              class="bg-primary text-white px-6 py-3 font-bold self-end text-xl animated-button rounded-full! disabled:opacity-50 disabled:cursor-not-allowed"
              @click.stop.prevent="goToTargets"
              :disabled="!form.canContinueToStep3.value"
            >
        ...
        <div
          ...
          class="w-full xl:py-4 xl:px-8 py-2 px-4 rounded-4xl transition-colors duration-400"
          :class="{ 'bg-primary-10': form.currentStep.value > 3 }"
          @click="form.currentStep.value = 3"
        >
          <div class="flex items-center justify-between">
            <div class="flex flex-col">
