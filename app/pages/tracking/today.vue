          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-4">
              ...
              >
                ...
                >
                  <div class="relative flex mx-1 mb-2 ">
                    <span
        ...
        <div class="flex-1 flex flex-col">
          ...
          >
            <div class="flex justify-between gap-10">
              ...
              <img
                class="w-30 h-30 -mt-14 object-contain rounded-full border-2 bg-primary-10 border-primary-10"
            ...
            >
              ...
              <div class="flex flex-col w-full mt-6">
                ...
                <div class="flex rounded-4xl bg-protein/10 relative h-8">
                  <div
                    class="absolute top-0 left-0 h-full rounded-4xl bg-protein flex items-center gap-2 px-2 transition-all duration-300 ease-in-out"
                    :style="{
                      width: `${
                        ((computedDailyNutrition?.protein || 0) / 156) * 90 + 10
                      }%`,
                    }"
                  >
                    <IconBeef class="w-6" />
              ...
              <div class="flex flex-col w-full mt-3">
                ...
                <div class="flex rounded-4xl bg-fat/10 relative h-8">
                  <div
                    ...
                    :style="{
                      width: `${
                        ((computedDailyNutrition?.fat || 0) / 70) * 90 + 10
                      }%`,
                    }"
                  >
