...
const naturalSourceThresholds = {
  ...
  0.05: {
    description: 'Almost all sugar from processed sources',
    ...generics.POOR,
  },
  0.1: { description: 'Most sugar from processed sources', ...generics.BAD },
  0.2: {
    description: 'Most sugar from processed sources',
    ...generics.SUBOPTIMAL,
  },
  0.5: {
    description: 'Half of the sugar from natural sources',
    ...generics.NEUTRAL,
  },
  0.6: {
    description: 'Majority of sugar from natural sources',
    ...generics.OKAY,
  },
  0.7: {
    description: 'Vast majority of sugar from natural sources',
    ...generics.GOOD,
  },
  0.8: {
    description: 'Almost all sugar from natural sources',
    ...generics.GREAT,
  },
...
export default function sugarToReadable(report: any, isFood: boolean) {
  ...
  items.push({
    ...percentOfKcalItem,
    description:
      percentOfKcalItem.description + ' impact on calories from sugar',
